...
public class VerbDao
{
  ...
  public Verb createVerb(Verb verb)
  {
    ...
    cv.put(DbHelper.COLUMN_PRESENT_SIMPLE , verb.getPresentSimple());
    cv.put(DbHelper.COLUMN_PAST_SIMPLE, String.valueOf(verb.getPastSimple()));
    cv.put(DbHelper.COLUMN_PRESENT_PERFECT , String.valueOf(verb.getPresentPerfect()));
  ...
  private Verb cursorToItem(Cursor cursor)
  {
    ...
    verb.setPresentSimple(cursor.getString(1));
